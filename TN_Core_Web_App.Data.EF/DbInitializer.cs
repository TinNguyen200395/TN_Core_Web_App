    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            if (_context.ProductCategories.Count() == 0)
            {
                ...
                {
                    new ProductCategory() { Name="Đồng Hồ",SeoAlias="dong-ho",ParentId = null,Status=Status.Active,SortOrder=1,
                    ...
                    new ProductCategory() { Name="Mắt Kính",SeoAlias="mat-kinh",ParentId = null,Status=Status.Active ,SortOrder=2,
                        Products = new List<Product>()
                        {
