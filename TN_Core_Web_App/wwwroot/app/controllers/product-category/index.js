        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            tn.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        tn.notify('Deleted success', 'success');
                        tn.stopLoading();
                        loadData();
                    },
                    error: function (status) {
                        tn.notify('Has an error in deleting progress', 'error');
                        tn.stopLoading();
                    }
                });
            });
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        tn.notify('Update success', 'success');
                    ...
                    error: function () {
                        tn.notify('Has an error in update progress', 'error');
                        tn.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = tn.unflattern(data);
